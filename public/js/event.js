    ...
    request.onload = function() {
        ...
        else 
        {
            ...
            for (curWeek = 0; curWeek < weeks; curWeek++)
            {
                ...
                html += "<tr style = \"line-height:20px;height:120px;font-size:9px;margin-bottom:7em;\">";        // row starts
                ...
                for (let i = 0; i < 7; i++)
                {
                    ...
                    {
                        curDate++;
                        html += "<td style=\"text-align:left;vertical-align:top;height:30px;padding-left:5px;\">" + "<p style=\"font-size:14px;padding-bottom:5px;\">"+curDate+"</p>" + "<br/>";
