...
const createLinkElement = link => {
  ...
  titleElement.appendChild(document.createTextNode(link.url));
  ...
  // Create DOM element for link headline, containing title and URL
...
const createInputElement = (name, placeholder, size) => {
  ...
  inputElement.setAttribute("requeired", "true");
...
const submitLink = e => {
  ...
  //Send link data to the server with an asynchronous POST request
...
const createLinkForm = () => {
  ...
  const linkFormatElement = document.createElement("form");
  linkFormatElement.classList.add("linkForm");
  linkFormatElement.classList.add("form-inline");
  linkFormatElement.appendChild(authorElement);
  linkFormatElement.appendChild(titleElement);
  linkFormatElement.appendChild(urlElement);
  linkFormatElement.appendChild(submitElement);

  // Handle form submission
  linkFormatElement.addEventListener("submit", submitLink);

  return linkFormatElement;
};
